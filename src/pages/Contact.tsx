      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Have questions about our services? We'd love to hear from you and help plan your
            perfect wedding day.
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg">hello@wedtube.com</p>
                  </div>
                </div>

                <div className="flex items-center">
                  <MapPin className="h-6 w-6 text-rose-500 mr-4" />
                  <div>
                    <p className="text-sm text-gray-500">Visit us</p>
                    <p className="text-lg">123 Wedding Street</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="wedding">Wedding Film Inquiry</option>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-rose-500 hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"
                >
